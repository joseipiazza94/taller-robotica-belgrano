...
## Nivel 0 - Arte, coordenadas y luz

Nuestro punto de partida con los más chiquitos fue un desafío que une el dibujo técnico con la electrónica básica: **Pixel Art**.

Trabajando en grillas de 8x8 y 16x16, aprendieron a ubicarse en el espacio a través de coordenadas. Una vez dominada la técnica, realizaron un dibujo mayor en el que ubicaron el punto exacto para colocar un LED. Por ahora, el LED se enciende mediante un circuito físico, permitiendo que entiendan el flujo de la energía de forma concreta y simple.
...
## Nivel 1 - De un videojuego al mundo real
...
## Nivel 2 - Subiendo la dificultad
